...
@section('content')
    <div class="card">
        ...
        <div class="card-content">
            <form action="{{ route('admin.area-parkir.add') }}" method="post">
                @csrf
                <div class="flex" style="gap: 5px">
                    <div class="error-parent field spaced" style="width: 100%;">
                        <label class="label">Nama Area</label>
                        <div class="control icons-left">
                            <input class="input auth" type="text" name="nama" placeholder="Nama Area Parkir" autocomplete="area_parkir">
                        </div>
                        @error('nama')
                        ...
                        <div class="control icons-left">
                            <div class="select">
                                <select name="kampus_id">
                                    ...
                                    <option value="{{ $kampus->id }}">{{ ucwords($kampus->nama) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="error-parent field spaced" style="width: 100%;">
                        ...
                        <div class="control icons-left">
                            <input class="input auth" type="number" name="kapasitas" placeholder="Kapasitas" autocomplete="kapasitas">
                        </div>
                        @error('kapasitas')
                            <span class="error">{{ $message }}</span>
                        @enderror
                ...
                <div class="error-parent field spaced">
                    ...
                    <div class="control icons-left">
                        <textarea class="textarea" name="keterangan" placeholder="Keterangan"></textarea>
                    </div>
                    @error('keterangan')
